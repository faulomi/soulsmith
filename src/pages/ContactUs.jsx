    ...
    <>
      <div className="container mt-5">
        <div className="row">
          <div className="col-12 col-lg-6 col-md-12 col-sm-12">
            ...
            <div className="row">
              ...
              <p className="col tw-text-bone">{t("Location")}</p>
            </div>

            <div className="row">
              <p className="col-3 tw-text-gold">Phone:</p>
              <p className="col tw-text-bone">+66 63 193 3642</p>
            </div>
          ...
          <div className="col-12 col-lg-6 col-md-12 col-sm-12 mt-4">
            ...
            >
              ...
              <div style={{ marginTop: "-35px" }} className="inline-block">
                <textarea
                  className="form-control tw-resize"
                  style={{ backgroundColor: "#E8E5D7" }}
                  rows="5"
              ...
              <button
                type="submit"
                className="w-25 rounded-1 tw-bg-gold tw-text-sm tw-text-bone py-3 mt-3"
              >
                <b>SEND</b>
              </button>
            </form>
        ...
        <div className="mx-auto my-5">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1905.5687291042332!2d100.5084235462813!3d13.725174239190665!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e299b2efbe5181%3A0x838a32522037d70a!2sEmpathy%20Sauce%20Co.%2CLtd.!5e0!3m2!1sen!2smm!4v1696956874400!5m2!1sen!2smm"
